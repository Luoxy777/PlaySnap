...
class SearchByCameraActivity : AppCompatActivity() {
    private lateinit var binding: ActivitySearchByCameraPageBinding
    ...
    private fun setFlashIcon(camera: Camera) {
        if (camera.cameraInfo.hasFlashUnit()) {
            if (camera.cameraInfo.torchState.value == 0) {
                ...
                binding.btnFlash.setCompoundDrawablesWithIntrinsicBounds(0,R.drawable.baseline_flash_off_24,0,0)
            }
        } else {
            Toast.makeText(
                this,
